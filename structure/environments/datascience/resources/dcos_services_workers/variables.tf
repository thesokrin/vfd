# Atlas Data-Science Environment - DC/OS Services Workers - Variables
...
variable "layer_public_cidr_blocks" {
  ...
  description = <<-EOF
    CIDR blocks for the three public subnets in the Atlas dsci environment.
  EOF
}
...
variable "layer_services_cidr_blocks" {
  ...
  description = <<-EOF
    CIDR blocks for the three services subnets in the Atlas dsci environment.
  EOF
}
...
variable "layer_services_subnet_ids" {
  ...
  description = <<-EOF
    Subnet ids for the three subnets in the services layer in the Atlas dsci environment.
  EOF
}
