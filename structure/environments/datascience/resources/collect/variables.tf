# Atlas Data-Science Environment - Collect Resources - Variables
...
variable "layer_admin_subnet_ids" {
  type = "list"
  description = <<-EOF
    A list of three subnet ids in the admin layer of the Atlas Data-Science Environment.
  EOF
}
...
variable "private_zone_id" {
  description = <<-EOF
    The private zone id for the Atlas Data-Science Environment.
  EOF
}
