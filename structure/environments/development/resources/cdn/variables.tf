# Atlas Development Environment - CDN Resources - Variables
...
variable "env_name_fancy" {
  description = <<-EOF
    The fancy name of the Atlas Development Environment.
  EOF
}

variable "env_name_short" {
  description = <<-EOF
    The short, slugified name of the Atlas Development Environment.
  EOF
}
