# Atlas Development Environment - Collect Resources - Variables
...
variable "env_name" {
  description = <<-EOF
    Long, slugified environment name of the Atlas Development Environment (development).
  EOF
}
...
variable "env_name_short" {
  description = <<-EOF
    Short, slugified environment name of the Atlas Development Environment.
  EOF
}
...
variable "layer_admin_subnet_ids" {
  type = "list"
  description = <<-EOF
    A list of three subnet ids in the admin layer of the Atlas Development Environment.
  EOF
}
...
variable "private_zone_id" {
  description = <<-EOF
    The private zone id for the Atlas Development Environment.
  EOF
}

variable "reverse_zone_id" {
  description = <<-EOF
    The reverse zone id for the Atlas Development Environment.
  EOF
}

variable "vpc_id" {
  description = <<-EOF
    The VPC ID of the Atlas Development Environment.
  EOF
}
