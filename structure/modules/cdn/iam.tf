# CDN Module - IAM Resources

resource "aws_iam_user" "default" {
  name = "atlas_${var.env_name_short}_${var.name}_cdn_curator_user"
}

resource "aws_iam_group" "default" {
  name = "atlas_${var.env_name_short}_${var.name}_cdn_curator_group"
}
...
resource "aws_iam_policy" "default" {
  name = "atlas_${var.env_name_short}_${var.name}_cdn_curator"
  description = "Allows read-write permissions to the CDN bucket for ${var.name}.${var.zone}"
