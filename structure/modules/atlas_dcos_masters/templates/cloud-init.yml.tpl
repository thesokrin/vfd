...
#   fqdn: zone name as in dev.grindr.io or dsci.grindr.io, etc.
#   hostname: name of instance, with appended zone/fqdn
#   aws_region: the region
#   mesos_cluster_name: name to call this mesos cluster
