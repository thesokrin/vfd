# Atlas DC/OS Services Workers Module - IAM

resource "aws_iam_instance_profile" "default" {
  name = "atlas_${var.stack_name_short}_dcos_services_workers_profile"
...
resource "aws_iam_role" "default" {
  name               = "atlas_${var.stack_name_short}_dcos_services_workers_role"
...
resource "aws_iam_policy" "default" {
  name        = "atlas_${var.stack_name_short}_dcos_services_workers"
